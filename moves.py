...
moves = {
    ...
    "Dark Pulse": Move("Dark Pulse","dark",80,"special"),
    "Knock Off": Move("Knock Off","dark",65,"physical"),

    "Psychic": Move("Psychic","psychic",90,"special"),
    "Psybeam": Move("Psybeam","psychic",65,"special"),

    "Shadow Ball": Move("Shadow Ball","ghost",80,"special"),
    "Shadow Claw": Move("Shadow Claw","ghost",75,"physical"),

    "Brave Bird": Move("Brave Bird","flying",120,"physical"),
    "Aerial Ace": Move("Aerial Ace","flying",60,"physical"),

    "X-Scissor": Move("X-Scissor","bug",80,"physical"),
    "Infestation": Move("Infestation","bug",10,"special"),
    
    "Sludge Bomb": Move("Sludge Bomb","poison",90,"special"),
    "Poison Jab": Move("Poison Jab","poison",80,"physical")
}